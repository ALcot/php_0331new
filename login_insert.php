...
//データ登録のSQL作成　　:a1は変数が入れられないので置き換え用
    $sql="INSERT INTO member_table(id, u_name, u_pw, indate)
    ...
    $stmt->bindValue(':a2',$u_pw, PDO::PARAM_STR);
...
<img src="img/タイト.png" alt="ヘッダー">
  ...
  <main>
    ...
    <h2 class="formArea">メンバー登録</h2>
        <?php if (count($err) >0) :?>
            <p class="formArea"><?php foreach($err as $em){
            echo $em."<br>";
            } ?>
            </p>
            
            <div class="shazai"><img class="shazai" src="img/ojigi_animal_neko.png" alt="謝罪ねこ"></div>
        ...
        <?php else: ?>
        <p class="formArea">メンバー登録が完了しました</p>
        
        <div class="in">
            <img src="img/登録完了画像.png" alt="登録完了画像">
        </div>

        <div class="formArea">
          <a class="formArea" href="index.php">ログイン画面へ戻る</a>
        </div>
        <?php endif; ?>
    </main>
              <footer>
